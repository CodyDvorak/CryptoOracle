...
const SCAN_TYPES = [
  ...
  { id: 'top500_scan', name: 'Top 500 Scan', duration: '5-7 min', coins: 500, bots: 87, description: 'Complete market coverage with all 87 bots. Multi-provider fallback ensures data quality.', aiEnabled: false },
  { id: 'high_conviction', name: 'High Conviction', duration: '2-3 min', coins: 200, bots: 87, description: '80%+ bot consensus detection across 87 bots. Strong agreement signals only.', aiEnabled: false },
  { id: 'trending_coins', name: 'Trending Markets', duration: '2-3 min', coins: 200, bots: 87, description: 'BULL regime detection (ADX > 25, golden alignment, momentum confirmation) using 26 trend-following bots.', aiEnabled: false },
  { id: 'reversal_opportunities', name: 'Reversal Opportunities', duration: '2-3 min', coins: 200, bots: 87, description: 'Mean-reversion strategies in SIDEWAYS regimes. RSI divergence + Bollinger squeeze + contrarian bots.', aiEnabled: false },
  { id: 'volatile_markets', name: 'Volatile Markets', duration: '2-3 min', coins: 200, bots: 87, description: 'High ATR (>4%) analyzed by 12 volatility bots. Expanded Bollinger Bands + Keltner Channels.', aiEnabled: false },
  { id: 'whale_activity', name: 'Whale Activity', duration: '2-3 min', coins: 200, bots: 87, description: 'Volume spike detection (>2.5x average) with 10 volume-based bots. Large price impact tracking.', aiEnabled: false },
  { id: 'futures_signals', name: 'Futures Signals', duration: '2-3 min', coins: 200, bots: 87, description: 'Real derivatives data: OKX funding rates, Binance OI, long/short ratios analyzed by 5 derivatives bots.', aiEnabled: false },
  { id: 'breakout_hunter', name: 'Breakout Hunter', duration: '2-3 min', coins: 200, bots: 87, description: 'Support/resistance breaks with volume confirmation using Donchian Channel + pattern recognition bots.', aiEnabled: false },
  { id: 'ai_powered_scan', name: 'AI-Powered Full Scan', duration: '3-4 min', coins: 100, bots: 87, description: 'All 87 bots + TokenMetrics AI + market regime classification + multi-layer consensus.', aiEnabled: true },
  { id: 'low_cap_gems', name: 'Low Cap Gems', duration: '3-4 min', coins: 300, bots: 87, description: 'Coins ranked 201-500 analyzed by all 87 bots with regime detection and on-chain metrics.', aiEnabled: false },
  { id: 'elliott_wave_scan', name: 'Elliott Wave Scan', duration: '2-3 min', coins: 200, bots: 87, description: 'Fibonacci retracement + Elliott Wave + Harmonic patterns analyzed by 10 pattern recognition bots.', aiEnabled: false },
