...
-- 2. Replace eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJib2x0IiwicmVmIjoiMGVjOTBiNTdkNmU5NWZjYmRhMTk4MzJmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTg4ODE1NzQsImV4cCI6MTc1ODg4MTU3NH0.9I8-U0x86Ak8t2DGaIk0HfvTSLsAyzdnz-Nw00mMkKw with your anon key from .env file
...
SELECT cron.schedule(
  ...
  SELECT extensions.http_post(
    url:='https://0ec90b57d6e95fcbda19832f.supabase.co/functions/v1/cron-trigger',
...
SELECT cron.schedule(
  ...
  $$
  SELECT extensions.http_post(
    url:='https://0ec90b57d6e95fcbda19832f.supabase.co/functions/v1/correlation-cron',
    headers:='{"Content-Type": "application/json", "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJib2x0IiwicmVmIjoiMGVjOTBiNTdkNmU5NWZjYmRhMTk4MzJmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTg4ODE1NzQsImV4cCI6MTc1ODg4MTU3NH0.9I8-U0x86Ak8t2DGaIk0HfvTSLsAyzdnz-Nw00mMkKw"}'::jsonb,
    body:='{}'::jsonb
  ) as request_id;
  $$
...
SELECT cron.schedule(
  ...
  $$
  SELECT extensions.http_post(
    url:='https://0ec90b57d6e95fcbda19832f.supabase.co/functions/v1/email-alerts',
    headers:='{"Content-Type": "application/json", "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJib2x0IiwicmVmIjoiMGVjOTBiNTdkNmU5NWZjYmRhMTk4MzJmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTg4ODE1NzQsImV4cCI6MTc1ODg4MTU3NH0.9I8-U0x86Ak8t2DGaIk0HfvTSLsAyzdnz-Nw00mMkKw"}'::jsonb,
...
SELECT cron.schedule(
  ...
  $$
  SELECT extensions.http_post(
    url:='https://0ec90b57d6e95fcbda19832f.supabase.co/functions/v1/scan-cleanup',
    headers:='{"Content-Type": "application/json", "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJib2x0IiwicmVmIjoiMGVjOTBiNTdkNmU5NWZjYmRhMTk4MzJmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTg4ODE1NzQsImV4cCI6MTc1ODg4MTU3NH0.9I8-U0x86Ak8t2DGaIk0HfvTSLsAyzdnz-Nw00mMkKw"}'::jsonb,
    body:='{"days": 30}'::jsonb
  ) as request_id;
  $$
